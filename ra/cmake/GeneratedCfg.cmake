...
set(RASC_TARGET_DEVICE R7FA6M4AF)

set(RASC_TARGET_ARCH cortex-m33)
set(RASC_PROJECT_NAME ext)
SET(RASC_TOOLCHAIN_NAME GCC)

SET(RASC_CMAKE_ASM_FLAGS "-mcmse;-mfloat-abi=hard;-mcpu=cortex-m33;-mfpu=fpv5-sp-d16;-Wunused;-Wuninitialized;-Wall;-Wextra;-Wmissing-declarations;-Wconversion;-Wpointer-arith;-Wshadow;-Wlogical-op;-Waggregate-return;-Wfloat-equal;-fmessage-length=0;-fsigned-char;-ffunction-sections;-fdata-sections;-mthumb;-x;assembler-with-cpp;-MMD;-MP")
SET(RASC_CMAKE_C_FLAGS "-mcmse;-mfloat-abi=hard;-mcpu=cortex-m33;-mfpu=fpv5-sp-d16;-Wunused;-Wuninitialized;-Wall;-Wextra;-Wmissing-declarations;-Wconversion;-Wpointer-arith;-Wshadow;-Wlogical-op;-Waggregate-return;-Wfloat-equal;-fmessage-length=0;-fsigned-char;-ffunction-sections;-fdata-sections;-mthumb;-std=c99;-MMD;-MP")
SET(RASC_CMAKE_CXX_FLAGS "-mcmse;-mfloat-abi=hard;-mcpu=cortex-m33;-mfpu=fpv5-sp-d16;-Wunused;-Wuninitialized;-Wall;-Wextra;-Wmissing-declarations;-Wconversion;-Wpointer-arith;-Wshadow;-Wlogical-op;-Waggregate-return;-Wfloat-equal;-fmessage-length=0;-fsigned-char;-ffunction-sections;-fdata-sections;-mthumb;-std=c++11;-MMD;-MP")
SET(RASC_CMAKE_EXE_LINKER_FLAGS "-mcmse;-mfloat-abi=hard;-mcpu=cortex-m33;-mfpu=fpv5-sp-d16;-Wunused;-Wuninitialized;-Wall;-Wextra;-Wmissing-declarations;-Wconversion;-Wpointer-arith;-Wshadow;-Wlogical-op;-Waggregate-return;-Wfloat-equal;-fmessage-length=0;-fsigned-char;-ffunction-sections;-fdata-sections;-mthumb;-T;script/fsp.ld;-Wl,--gc-sections;-Wl,-Map,${CMAKE_CURRENT_BINARY_DIR}/${PROJECT_NAME}.map;-Wl,--print-memory-usage;-Wl,--cmse-implib;-Wl,--out-implib=${CMAKE_CURRENT_BINARY_DIR}/secure.o;--specs=nano.specs;-o;${PROJECT_NAME}.elf")
SET(RASC_CMAKE_DEFINITIONS "_RENESAS_RA_;_RA_TZ_SECURE;_RA_CORE=CM33;_RA_ORDINAL=1")
...
SET(RASC_C_DEBUG_FLAGS "-g;-O2")
SET(RASC_CXX_DEBUG_FLAGS "-g;-O2")
SET(RASC_ASM_DEBUG_FLAGS "-g;-O2")
