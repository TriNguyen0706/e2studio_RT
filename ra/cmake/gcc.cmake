...
if(DEFINED ENV{ARM_GCC_TOOLCHAIN_PATH} AND NOT ENV{ARM_GCC_TOOLCHAIN_PATH} STREQUAL "")
  message("Using ARM_GCC_TOOLCHAIN_PATH defined in environment: $ENV{ARM_GCC_TOOLCHAIN_PATH}")
...
elseif(DEFINED ENV{ARM_TOOLCHAIN_PATH} AND NOT ENV{ARM_TOOLCHAIN_PATH} STREQUAL "")
  ...
  message(FATAL_ERROR "Toolchain path not defined. Please set ARM_GCC_TOOLCHAIN_PATH variable to set the toolchain's bin folder")
endif()
