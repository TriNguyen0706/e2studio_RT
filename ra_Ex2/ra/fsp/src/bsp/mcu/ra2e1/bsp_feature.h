...
#define BSP_FEATURE_ACMPLP_HAS_COMPSEL_REGISTERS                        (0UL)           // COMPSELn registers are available.
...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS_MASK                            (0x007F07FFUL)  // Mask of available channels in ADC unit 0.
...
#define BSP_FEATURE_ICU_WUPEN_MASK                                      (0xF38F00FFULL) // A mask of valid bits for [WUPEN1:WUPEN0].
