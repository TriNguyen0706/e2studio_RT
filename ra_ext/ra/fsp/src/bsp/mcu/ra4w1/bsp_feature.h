...
#define BSP_FEATURE_ADC_MAX_RESOLUTION_BITS                             (14UL)          // Maximum ADC resolution supported.
...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS_MASK                            (0x001A0670UL)  // Mask of available channels in ADC unit 0.
...
#define BSP_FEATURE_BSP_MPU_REGION0_MASK                                (0x00FFFFFFUL)  // Mask for allowed address range of the MPU.
...
#define BSP_FEATURE_BSP_VBATT_HAS_VBTCR1_BPWSWSTP                       (1UL)           // VCC can switch to VBAT if the voltage drops too low.

#define BSP_FEATURE_CAN_IS_AVAILABLE                                    (1UL)
#define BSP_FEATURE_CAN_CHECK_PCLKB_RATIO_FLAG                          (1UL)           // Flag indicating that the ratio between PCLKA (or ICLK) and PCLKB must be 2:1 during CAN operation.
#define BSP_FEATURE_CAN_CLOCK                                           (FSP_PRIV_CLOCK_PCLKA)  // Source clock for the CAN peripheral.
...
#define BSP_FEATURE_CGC_MIDDLE_SPEED_MAX_FREQ_HZ                        (8000000UL)     // Middle speed clock maximum frequency.
...
#define BSP_FEATURE_CGC_PLL_INPUT_POST_DIV_MAX_HZ                       (12500000UL)    // Maximum input frequency for PLL (after input divider).
#define BSP_FEATURE_CGC_PLL_INPUT_POST_DIV_MIN_HZ                       (4000000UL)     // Minimum input frequency for PLL (after input divider).
...
#define BSP_FEATURE_CGC_PLL_OUT_MAX_HZ                                  (64000000UL)    // Maximum output frequency for PLL unit 1.
#define BSP_FEATURE_CGC_PLL_OUT_MIN_HZ                                  (24000000UL)    // Minimum output frequency for PLL unit 1.
...
#define BSP_FEATURE_CGC_PLLCCR_TYPE                                     (2UL)           // Indicates the type of PLLCCR register and PLL.
...
#define BSP_FEATURE_CGC_PLLCCR_WAIT_US                                  (1UL)           // Time required, in microseconds, between changing PLLCCR.PLLMUL to clearing PLLCR.PLLSTP.
#define BSP_FEATURE_CGC_REGISTER_SET_B                                  (0UL)           // Clock generation uses an alternative register set.
#define BSP_FEATURE_CGC_SCKDIVCR_BCLK_MATCHES_PCLKB                     (1UL)           // Requires the SCKDIVCR.BCLK bits [18:16] to match SCKDIVCR.PCLKB.
...
#define BSP_FEATURE_CGC_STARTUP_SCKDIVCR                                (0x44044444UL)  // Reset value for the SCKDIVCR register.
...
#define BSP_FEATURE_CTSU_CORRECTION_TYPE                                (1UL)           // CTSU correction algorithm type.
#define BSP_FEATURE_CTSU_CTSUCHAC_REGISTER_COUNT                        (5UL)           // Number of CTSUCHAC registers.
#define BSP_FEATURE_CTSU_CTSUCHTRC_REGISTER_COUNT                       (5UL)           // Number of CTSUCHTRC registers.
...
#define BSP_FEATURE_DAC8_HAS_CHARGEPUMP                                 (0UL)           // DACPC register is available.
#define BSP_FEATURE_DAC8_HAS_DA_AD_SYNCHRONIZE                          (0UL)           // DACADSCR register is available.
#define BSP_FEATURE_DAC8_HAS_REALTIME_MODE                              (0UL)           // DAM register has DAMDn bit-fields.
...
#define BSP_FEATURE_DMAC_HAS_REPEAT_BLOCK_MODE                          (0UL)           // DMTMD register's MD bit-field allows repeat-block transfers (value: 0b11).
#define BSP_FEATURE_DMAC_NUM_CHANNELS                                   (4UL)           // Number of DMAC channels available.
...
#define BSP_FEATURE_FLASH_CACHE_DISABLE_OPM                             (1UL)           // Constraints exist for flash cache operation either during power mode sequencing or flash programming access.
...
#define BSP_FEATURE_GPT_EVENT_COUNT_CHANNEL_MASK                        (0x013FUL)      // Mask of channels that support event count input (has GTUPSR register).
...
#define BSP_FEATURE_GPT_GTDVU_CHANNEL_MASK                              (0x013FUL)      // Mask of channels that support dead time control.
...
#define BSP_FEATURE_GPT_MSTP_MSTPD5_MAX_CH                              (3UL)           // Largest channel number associated with GPT on the MSTPCRD.MSTPD5 field on this MCU.
...
#define BSP_FEATURE_ICU_IRQ_CHANNELS_MASK                               (0xCBDFUL)      // Mask of available IRQ control registers.
...
#define BSP_FEATURE_ICU_WUPEN_MASK                                      (0xFB97CBDFULL) // A mask of valid bits for [WUPEN1:WUPEN0].
...
#define BSP_FEATURE_LPM_SNZREQCR_MASK                                   (0x7382CADFULL) // Mask of valid bits for the SNZREQCRn registers.
...
#define BSP_FEATURE_OPAMP_BASE_ADDRESS                                  (1UL)           // Width of the AMPSP bit-field.
#define BSP_FEATURE_OPAMP_HAS_MIDDLE_SPEED                              (0UL)           // The op-amp has middle-speed capabilities.
#define BSP_FEATURE_OPAMP_HAS_SWITCHES                                  (0UL)           // Op-amp input/output can be switched between different input/output combinations.
#define BSP_FEATURE_OPAMP_MIN_WAIT_TIME_HS_US                           (13UL)          // Minimum wait time required after turn on for high-speed mode, in microseconds.
#define BSP_FEATURE_OPAMP_MIN_WAIT_TIME_LP_US                           (650UL)         // Minimum wait time required after turn on for low power mode, in microseconds.
#define BSP_FEATURE_OPAMP_MIN_WAIT_TIME_MS_US                           (0UL)           // Minimum wait time required after turn on for middle-speed mode, in microseconds.
#define BSP_FEATURE_OPAMP_TRIM_CAPABLE                                  (0UL)           // User configurable input offset trimming is available.
#define BSP_FEATURE_OPAMP_VARIANT_CHANNEL_MASK                          (0x0FUL)        // Mask of valid op-amp channels.
...
#define BSP_FEATURE_RSIP_SCE5_SUPPORTED                                 (1UL)           // The device supports cryptography using SCE5.
...
#define BSP_FEATURE_RTC_RTCCR_CHANNELS                                  (1UL)           // Number of RTCCRn registers that are available.
...
#define BSP_FEATURE_SCI_ADDRESS_MATCH_CHANNELS_MASK                     (0x0213UL)      // Mask of channels with data compare match (DCCR) available.
#define BSP_FEATURE_SCI_CHANNELS_MASK                                   (0x0213UL)      // Mask of available SCI channels.
...
#define BSP_FEATURE_SCI_UART_FIFO_CHANNELS_MASK                         (0x03UL)        // Mask of channels which support the UART FIFO.
...
#define BSP_FEATURE_SLCDC_IS_AVAILABLE                                  (1UL)
#define BSP_FEATURE_SLCDC_CONTRAST_MAX                                  (0UL)           // Maximum contrast index for standard bias methods.
#define BSP_FEATURE_SLCDC_CONTRAST_MAX_4BIAS                            (0UL)           // Maximum contrast index for 1/4 bias method.
#define BSP_FEATURE_SLCDC_HAS_8_TIME_SLICE                              (0UL)           // LCD waveform supports 8-time slices.
#define BSP_FEATURE_SLCDC_HAS_INTERNAL_VOLT_GEN                         (0UL)           // Internal voltage generation is available.
#define BSP_FEATURE_SLCDC_HAS_VL1SEL                                    (0UL)           // Internal voltage generator can be used as the LCD reference voltage.
#define BSP_FEATURE_SLCDC_HAS_VLCD_MDSET2                               (0UL)           // VLCD register has MDSET2.
#define BSP_FEATURE_SLCDC_MAX_NUM_SEG                                   (53UL)          // Maximum index of supported segment registers.
...
#define BSP_FEATURE_SPI_SSL_LEVEL_KEEP_VALID_CHANNEL_MASK               (0x01UL)        // Mask of channel indices that support SSL Level Keep.
...
#define BSP_FEATURE_USB_HAS_CLOCK_REQ                                   (0UL)           // Indicates that a request bit must be set before changing USB clock settings.
#define BSP_FEATURE_USB_HAS_CLOCK_SEL                                   (1UL)           // Indicates the USB clock has a selectable source.
#define BSP_FEATURE_USB_HAS_CLOCK_SEL_ALT                               (1UL)           // Indicates the USBCKCR_ALT register should be used instead of USBCKCR.
...
#define BSP_FEATURE_USB_HAS_USBCKDIVCR                                  (0UL)           // USBCKDIVCR register is available.
